...
import type { NovaUser } from '@/lib/auth-core';
import { LogoutButton, SessionGuard } from './auth';
...
const accountLinks = [{ href: '/perfil', label: 'Perfil', Icon: UserRound }, { href: '/seguridad', label: 'Seguridad', Icon: Settings2 }, { href: '/ajustes', label: 'Configuración', Icon: Settings2 }, { href: '/ayuda', label: 'Ayuda', Icon: CircleHelp }, { href: '/feedback', label: 'Feedback del piloto', Icon: MessageSquare }];
